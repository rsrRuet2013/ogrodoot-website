...
export const metadata = {
  title: "My Profile | Team Ogrodoot",
  description: "Manage and update your Team Ogrodoot member profile, contact details, and photo.",
};
...
export default function ProfilePage() {
  return (
    <main className="min-h-screen bg-[#050505] text-white px-4 sm:px-6 lg:px-8 pb-20 pt-28">
      ...
      <section className="mx-auto max-w-5xl relative z-10 pt-8">
        ...
        <div className="flex items-center gap-2 mb-6 text-xs text-white/50">
          ...
          <Link href="/team" className="hover:text-mars-orange transition-colors">
            Team
          </Link>
          <ChevronRight size={12} className="text-white/30" />
          <span className="text-mars-orange font-semibold">My Profile</span>
        </div>
        ...
        <div className="mb-10">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-mars-orange/10 border border-mars-orange/30 text-mars-orange text-[11px] font-mono uppercase tracking-[0.25em] mb-4">
            <UserCheck size={13} className="text-mars-orange" />
            Personnel File
          </div>
          ...
          <p className="mt-2 text-sm text-white/70 max-w-2xl font-normal leading-relaxed">
            Keep your member details up to date, replace your roster photo, update your mobile number, or link your LinkedIn account.
          </p>
        </div>
